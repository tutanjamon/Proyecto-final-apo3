...
public class GestorArchivos {
    ...
    // Constructor que recibe la ruta del archivo donde se guardarán y cargarán las tareas
    public GestorArchivos(String rutaArchivo) {
        this.rutaArchivo = rutaArchivo;
    }

    // Método para cargar las tareas desde el archivo de texto
    ...
    // Método para guardar la lista de tareas en el archivo de texto
